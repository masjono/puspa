...
class uploadhandler {
    ...
    function __construct() {
        // do nothing
		//parent::__construct();
		// aslinya isi construct adalah melakukan proses upload, pada 2013-10-20 dipindahkan ke function do_upload()
    }
	
	function do_upload($username, $id_entity, $options = null, $initialize = true, $error_messages = null) {
		$this->id_entity = $id_entity;
		$this->options = array(
            'script_url' => $this->get_full_url() . '/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . '/assets/gallery/'.$id_entity.'/',
            'upload_url' => $this->get_full_url() . '/assets/gallery/'.$id_entity.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function set_additional_file_properties($file) {
        $file->deleteUrl = $this->options['script_url'] .'index.php/kegiatan/dodeletefile/'
                . $this->get_query_separator($this->options['script_url'])
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) {
		...
		$file->name = preg_replace("/[^A-Za-z0-9.]/", "-", $file->name); // dani 20131021
