    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return this.nonSelectedText + ' <b class="icon icon-caret-down"></b>';
                }
                else {
                    if (options.length > this.numberDisplayed) {
                        return options.length + ' ' + this.nSelectedText + ' <b class="icon icon-caret-down"></b>';
                    }
                    else {
                        var selected = '';
                        ...
                        return selected.substr(0, selected.length - 2) + ' <b class="icon icon-caret-down white"></b>';
                    }
                }
            },
            /**
...
//            buttonWidth: 'auto',
            ...
            nonSelectedText: 'Belum Ditetapkan',
